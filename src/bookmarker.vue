    ...
    <div >
        ...
        <div class="container">
            ...
            <div id="myForm">
                ...
                <button @click="submitBookmark" style="background-color: #4CAF50;">Submit</button>
            </div>
        </div>

        <div class="row marketing" >
            <div class="col-lg-12">
                <div v-for="bookmark in bookmarks" :key="bookmark.name" >

                    <h3>Name : {{bookmark.name}}<br>
...
export default {
    ...
    methods: {
        submitBookmark() {
            ...
            this.$http.post('https://bookmarks-4cefd.firebaseio.com/Bookmark.json', this.Ibookmark)
        ...
        deleteBookmark(bookmark) {
            ...
            this.$http.delete('https://bookmarks-4cefd.firebaseio.com/Bookmark/'+bookmark.key+'.json', this.Ibookmark)
                .then(response => {         // define how to deal with the response
                    console.log(response);
                    this.fetchData()
                    this.resetbookmark();
        ...
        fetchData() {
            ...
            this.$http.get('https://bookmarks-4cefd.firebaseio.com/Bookmark.json')
                .then(response => {
